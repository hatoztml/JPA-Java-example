...
@NamedQueries({
		...
		@NamedQuery(name = "User.findUserInfoByUsername", query = "select new com.proje.model.UserInfo(u.username, u.userDetail.firstName, u.userDetail.lastName, u.userDetail.birthDate) From User u where u.username=:username") })
public class User implements Serializable {
	...
	public User(String username, String password, UserDetail userDetail, Date creationDate) {
		super();
		this.username = username;
		this.password = password;
		this.creationDate = creationDate;
